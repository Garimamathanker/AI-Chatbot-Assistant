...
GEMINI_MODEL = "gemma-3-12b-it"  # Gemini model to use
...
# --- RAG Settings ---
RERANK_TOP_N =4  # Number of results needed after reranking (reduced for token efficiency)
SIMILARITY_TOP_K = 7# Number of results to fetch initially in vector search (reduced for token efficiency)
